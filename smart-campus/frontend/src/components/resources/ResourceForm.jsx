  ...
  return (
    <div className="w-full relative">
      ...
      <div className="max-w-3xl mx-auto pb-8 px-4 sm:px-6 lg:px-8 -mt-8">
        ...
        <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-xl border border-slate-100 dark:border-cyan-300/20 overflow-hidden backdrop-blur-sm backdrop-filter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-cyan-300/20 text-slate-900 dark:text-white dark:placeholder-slate-500 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.type}
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-cyan-300/20 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none appearance-none"
                >
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-cyan-300/20 text-slate-900 dark:text-white dark:placeholder-slate-500 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none resize-none"
                />
              </div>
