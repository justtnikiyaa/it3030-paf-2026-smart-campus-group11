  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <button 
          onClick={() => navigate("/resources")} 
          className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors bg-white px-4 py-2 rounded-full border border-gray-200 shadow-sm"
        >
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg border flex items-center transition-all ${
                resource.status === 'ACTIVE' 
                  ? 'border-orange-200 text-orange-700 hover:bg-orange-50 bg-white'
      ...
      <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden relative">
        ...
        <div className="p-8 sm:p-10">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-10 border-b border-gray-100 pb-8">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase bg-indigo-50 text-indigo-700 border border-indigo-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div>
                ...
                <dl className="grid grid-cols-1 gap-y-4">
                  <div className="flex items-start">
                    ...
                    <dd className="text-lg font-medium text-gray-900">{resource.location}</dd>
                  </div>
                  ...
                  {resource.capacity && (
                    <div className="flex items-start">
                      ...
                      <dd className="text-lg font-medium text-gray-900">{resource.capacity} People Capacity</dd>
                    </div>
                  )}
                  ...
                  {resource.availabilityWindows && (
                    <div className="flex items-start">
                      ...
                      <dd className="text-lg font-medium text-gray-900">{resource.availabilityWindows}</dd>
                    </div>
                  )}
                </dl>
              </div>
            ...
            <div>
              ...
              <div className="prose prose-blue text-gray-600 bg-gray-50 rounded-2xl p-6 border border-gray-100">
                {resource.description ? (
                  <p className="whitespace-pre-wrap m-0 leading-relaxed">{resource.description}</p>
                ) : (
                  <p className="m-0 italic text-gray-400">No description provided for this resource.</p>
                )}
              </div>
              
              <div className="mt-8 text-xs text-gray-400 space-y-1 pl-1">
